        ...
        for (var j = 0; j < unsortedPositions.length; j++) {
            ...
            for (var i = 0; i < p.length; i++) {
                ...
                if (positions[j][Math.floor(p[i].x / lodObjectSize)][Math.floor(p[i].y / lodObjectSize)] === undefined || positions[j][Math.floor(p[i].x / lodObjectSize)][Math.floor(p[i].y / lodObjectSize)] === null) {
                    positions[j][Math.floor(p[i].x / lodObjectSize)][Math.floor(p[i].y / lodObjectSize)] = [];
                }
                ...
                for (var lodLevel = 0; lodLevel < this.lodTemplates.length; lodLevel++) {
                    ...
                    if (this.lodTemplates[lodLevel].mode == "2d") {
                        ...
                        for (var positionIdx = 0; positionIdx < posArray.length; positionIdx++) {
                            ...
                            var mesh = this.lodTemplates[lodLevel].meshes[pos.meshIdx].clone();
                            ...
                            if (terrain !== undefined) {
                                mesh.position.y += this.calculateHeight(lod.position.x + mesh.position.x, lod.position.z + mesh.position.z);
                            }
